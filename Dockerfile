FROM ubuntu:14.04
MAINTAINER Jorge Campos "jorge.camposserrano@gmail.com"
...
###########################
RUN wget -O /tmp/sonar.deb http://sourceforge.net/projects/sonar-pkg/files/deb/binary/sonar_$SONAR_VERSION.deb/download
